...
// Not using std::collections::VecDeque because of compatibility problems with WebAssembly builds.
        ...
        match (digit1, digit2, digit3, digit4) {
            ...
            (0xD, _, _, _) => {
                ...
                for y_line in 0..num_rows {
                    // Determine in which memory address our row's data is stored
